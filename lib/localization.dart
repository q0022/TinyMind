class AppTranslations {
  static const Map<String, Map<String, String>> _localizedValues = {
    'th': {
      ...
      'dict_clear_all_btn': 'ล้างพจนานุกรมส่วนตัวทั้งหมด',
      'ignored_count_label': 'จำนวนคำศัพท์ที่ละเว้น',
      'clear_dict_confirm_title': 'ยืนยันการล้างพจนานุกรมส่วนตัว',
      'clear_dict_confirm_desc': 'คุณต้องการล้างรายการคำศัพท์ที่ละเว้น และประวัติการเรียนรู้คำภาษาอังกฤษทั้งหมดใช่หรือไม่? การกระทำนี้ไม่สามารถย้อนกลับได้ค่ะ',
      'clear_dict_success': 'ล้างพจนานุกรมส่วนตัวทั้งหมดเรียบร้อยแล้วค่ะ',
      'cancel': 'ยกเลิก',
      'confirm': 'ยืนยัน',
    ...
    'en': {
      ...
      'dict_clear_all_btn': 'Clear All Personal Dictionary',
      'ignored_count_label': 'Ignored Words Count',
      'clear_dict_confirm_title': 'Confirm Clearing Personal Dictionary',
      'clear_dict_confirm_desc': 'Do you want to clear all ignored words and learned English words history? This action cannot be undone.',
      'clear_dict_success': 'Successfully cleared all personal dictionary entries.',
      'cancel': 'Cancel',
      'confirm': 'Confirm',
